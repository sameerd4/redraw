...
county_vote_dict = {}
with open('data_2004.csv', encoding='latin1') as f:
    reader = csv.reader(f)
    next(reader)
    for line in reader:
    ...
    while i < 3115:
        if 'properties' in data['objects']['counties']['geometries'][i]:
          #  print(data['objects']['counties']['geometries'][i]['properties'])
            ...
            if county == 'Kings' and state == 'NY':
                data['objects']['counties']['geometries'][i]['properties']['dem'] = 514973
                data['objects']['counties']['geometries'][i]['properties']['gop'] = 167149
            ...
            elif county == 'Richmond' and state == 'NY':
                data['objects']['counties']['geometries'][i]['properties']['dem'] = 68448
                data['objects']['counties']['geometries'][i]['properties']['gop'] = 90325
                data['objects']['counties']['geometries'][i]['properties']['lib'] = 0
                data['objects']['counties']['geometries'][i]['properties']['oth'] = 0
                data['objects']['counties']['geometries'][i]['properties']['una'] = 0
            else:    
...
'''
with open('us2004.json', 'w') as outfile:
